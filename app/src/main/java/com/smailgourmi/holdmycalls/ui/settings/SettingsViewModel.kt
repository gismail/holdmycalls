...
class SettingsViewModelFactory(private val userID: String,private val dbRepository: DatabaseRepository,
                               private val storageRepository: StorageRepository,
                               private val authRepository: AuthRepository) : ViewModelProvider.NewInstanceFactory(){
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return SettingsViewModel(userID,dbRepository,storageRepository,authRepository) as T
    }
}

class SettingsViewModel(private val userID: String,private val dbRepository: DatabaseRepository,
                        private val storageRepository: StorageRepository,
                        private val authRepository: AuthRepository) : DefaultViewModel() {
